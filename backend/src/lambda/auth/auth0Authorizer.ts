...
const jwksUrl = 'https://dev-vxwdr4fwwuamczd0.us.auth0.com/.well-known/jwks.json'
...
async function verifyToken(authHeader: string): Promise<JwtPayload> {
  ...
  logger.info('signingKey', signingKeys)

  if (!signingKeys) {
    throw new Error('The JKWS endpoint did not container any keys')
  }
